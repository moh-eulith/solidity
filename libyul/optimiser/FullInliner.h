...
private:
	...
	FullInliner(Block& _ast, LabelIDDispenser& _dispenser, Dialect const& _dialect);
	void run(Pass _pass);
...
{
public:
	InlineModifier(FullInliner& _driver, LabelIDDispenser& _nameDispenser, YulName _functionName, Dialect const& _dialect):
