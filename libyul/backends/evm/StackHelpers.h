...
inline std::string stackSlotToString(StackSlot const& _slot, ASTLabelRegistry const& _labels, Dialect const& _dialect)
{
...
inline std::string stackToString(Stack const& _stack, ASTLabelRegistry const& _labels, Dialect const& _dialect)
{
	std::string result("[ ");
