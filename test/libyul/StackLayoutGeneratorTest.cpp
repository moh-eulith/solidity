...
{
public:
	explicit VariableSlotToStringTransform(ASTLabelRegistry const& _labels): m_labels(_labels) {}
...
{
public:
	StackLayoutPrinter(std::ostream& _stream, StackLayout const& _stackLayout, Dialect const& _dialect, ASTLabelRegistry const& _labels):
