...
namespace
{
std::string_view variableSlotToString(VariableSlot const& _slot, ASTLabelRegistry const& _labels)
{
...
{
public:
	ControlFlowGraphPrinter(std::ostream& _stream, Dialect const& _dialect, ASTLabelRegistry const& _labels):
		m_stream(_stream),
		m_dialect(_dialect),
		m_labels(_labels)
	{
