...
// [ c RET a b x TMP[mload, 0] ]\l\
// Assignment(GHOST[6])\l\
// [ c RET a b x GHOST[6] ]\l\
// [ c RET a b x GHOST[6] GHOST[6] 0x00 ]\l\
// eq\l\
// [ c RET a b x GHOST[6] TMP[eq, 0] ]\l\
// [ c RET a b x GHOST[6] TMP[eq, 0] ]\l\
// "];
// Block4 -> Block4Exit;
...
// Block7 [label="\
// [ c RET a b x GHOST[6] ]\l\
// [ c RET a b x GHOST[6] GHOST[6] 0x01 ]\l\
// eq\l\
// [ c RET a b x GHOST[6] TMP[eq, 0] ]\l\
// [ c RET a b x GHOST[6] TMP[eq, 0] ]\l\
// "];
...
// Block9 [label="\
// [ c RET a b x GHOST[6] ]\l\
// [ c RET a b x GHOST[6] GHOST[6] 0x02 ]\l\
// eq\l\
// [ c RET a b x GHOST[6] TMP[eq, 0] ]\l\
// [ c RET a b x GHOST[6] TMP[eq, 0] ]\l\
// "];
